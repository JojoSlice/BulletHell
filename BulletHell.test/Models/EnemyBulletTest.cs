...
public class EnemyBulletTest(ITestOutputHelper output)
{
    ...
    public void EnemyBullet_ShouldMoveAccordingToVelocity()
    {
        ...
        using var enemyBullet = new Bullet<Enemy>(startPosition, velocity, mockSprite);
    ...
    public void Constructor_ShouldInitializeCollider()
    {
        ...
        // Act
        using var bullet = new Bullet<Enemy>(startPosition, Vector2.UnitY, mockSprite);
    ...
    public void Update_ShouldKeepColliderInSyncWithPosition()
    {
        ...
        using var bullet = new Bullet<Enemy>(startPosition, velocity, mockSprite);
    ...
    public void UpdateColliderRadiusFromSprite_ShouldSetRadiusBasedOnSprite()
    {
        ...
        using var bullet = new Bullet<Enemy>(Vector2.Zero, Vector2.UnitY, mockSprite);
